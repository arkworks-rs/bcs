...
use crate::iop::message::MsgRoundRef;
    ...
    MTG::InnerDigest: AbsorbGadget<F>,
{
    ...
    pub fn submit_verifier_current_round(&mut self, namespace: &NameSpace, tracer: TraceInfo) -> MsgRoundRef {
        #[cfg(feature = "print-trace")]
        {
            ...
            (0..indices_in_current_namespace_pt
                ...
                .for_each(|i| {
                    ...
                    let verifier_message_vt = &verifier_transcript.reconstructed_verifier_messages
                        [indices_in_current_namespace_vt.verifier_message_refs[i].index].value().unwrap();
                    assert_eq!(
