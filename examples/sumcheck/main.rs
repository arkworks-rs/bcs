...
fn main() {
    ...
    let proof =
        BCSProof::generate_without_ldt::<SimpleSumcheckVerifier<Fr>, SimpleSumcheckProver<Fr>, _>(
            sponge,
            &vp,
            &(),
            &testing_poly,
    ...
    let sponge = PoseidonSponge::new(&poseidon_parameters());
    let verifier_output = BCSVerifier::verify_without_ldt::<SimpleSumcheckVerifier<Fr>, _>(
        sponge,
        &proof,
        &vp,
        &testing_poly,
