...
use ark_std::{One, str::FromStr, Zero};

type F = ark_bls12_381::Fr;
pub type H = poseidon::CRH<Fr>;
pub type TwoToOneH = poseidon::TwoToOneCRH<Fr>;
...
pub fn poseidon_parameters() -> PoseidonParameters<Fr> {
    let full_rounds = 8;
    ...
    PoseidonParameters::<F>::new(full_rounds, partial_rounds, alpha, mds, ark, 2, 1)
}
